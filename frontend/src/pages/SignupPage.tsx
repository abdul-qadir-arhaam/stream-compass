...
import { Compass, AlertCircle, ArrowRight, Lock, Mail, User as UserIcon } from 'lucide-react';
    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12 bg-obsidian-950">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-white tracking-tight">Calibrate Your Compass</h2>
          <p className="text-sm text-slate-400 mt-1">
            Build your personalized movie & series decision profile
          </p>
        </div>
        ...
        <div className="p-8 rounded-2xl bg-obsidian-900/80 border border-white/10 shadow-2xl backdrop-blur-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {isSubmitting ? (
                ...
                <>
                  <span>Create Taste Profile</span>
          ...
          <div className="mt-6 pt-6 border-t border-white/5 text-center text-xs text-slate-400">
            Already calibrated?{' '}
            <Link to="/login" className="text-compass-400 hover:text-compass-300 font-semibold ml-1">
              Sign in
            </Link>
          </div>
        </div>
